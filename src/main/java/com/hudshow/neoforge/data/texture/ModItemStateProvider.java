package com.hudshow.neoforge.data.texture;

import com.hudshow.neoforge.MagicMirror;
import com.hudshow.neoforge.core.init.ItemInit;
import com.hudshow.neoforge.util.NameUtility;
...
public class ModItemStateProvider extends ItemModelProvider {
    public ModItemStateProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, MagicMirror.MOD_ID, existingFileHelper);
    }
    ...
    protected void registerModels() {
        ...
        item(ItemInit.MAGIC_MIRROR.get());
